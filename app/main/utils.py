...
def calculate_days_to_deadline(current_date=datetime.date(datetime.now())):
    ...
    :param current_date: datetime object representing today's date in format yyyy-mm-dd HH:MM:SS
    Returns:
